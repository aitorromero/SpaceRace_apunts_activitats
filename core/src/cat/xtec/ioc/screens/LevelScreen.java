...
public class LevelScreen implements Screen{
    ...
    public LevelScreen(SpaceRace game) {
        ...
        facil.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                LevelScreen.this.game.setScreen(new GameScreen(LevelScreen.this.stage.getBatch(), LevelScreen.this.stage.getViewport(), "facil"));
                dispose();
            }
        });
        ...
        medio.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                LevelScreen.this.game.setScreen(new GameScreen(LevelScreen.this.stage.getBatch(), LevelScreen.this.stage.getViewport(), "medio"));
                dispose();
            }
        });
        ...
        dificil.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                LevelScreen.this.game.setScreen(new GameScreen(LevelScreen.this.stage.getBatch(), LevelScreen.this.stage.getViewport(), "dificil"));
                dispose();
            }
        });
